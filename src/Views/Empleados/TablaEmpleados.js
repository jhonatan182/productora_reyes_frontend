...
function GetEmpleados() {
    ...
    const peticionGet = async () => {
        await axiosPrivate
            .get(process.env.REACT_APP_API_HOST + '/empleados/listar')
            .then((response) => {
        ...
        await axiosPrivate
            ...
            .then((response) => {
                setData(
                    data.filter(
                        (empleado) =>
                            empleado.id_empleado !== formValues.id_empleado
                    )
                );
    ...
    const bodyInsertar = (
        <div className={styles.modal}>
            ...
            <TextField
                className={styles.inputMaterial}
                label="Codido de Rol del Empleado"
                name="rol_id"
                onChange={handleChange}
            />
            <br />
    ...
    const bodyEditar = (
        <div className={styles.modal}>
            ...
            <TextField
                ...
                name="nombre_empleado"
                onChange={handleChange}
                value={formValues && formValues.nombre_empleado}
            />
            <br />
            <TextField
                className={styles.inputMaterial}
                ...
                name="apellido_empleado"
                onChange={handleChange}
                value={formValues && formValues.apellido_empleado}
            />
            <br />
            <TextField
                className={styles.inputMaterial}
                ...
                name="identidad_empleado"
                onChange={handleChange}
                value={formValues && formValues.identidad_empleado}
            />
            <br />
            <TextField
                className={styles.inputMaterial}
                ...
                name="telefono_empleado"
                onChange={handleChange}
                value={formValues && formValues.telefono_empleado}
            />
            <br />
            <TextField
                className={styles.inputMaterial}
                ...
                name="correo_empleado"
                onChange={handleChange}
                value={formValues && formValues.correo_empleado}
            />
            <br />
            <TextField
                className={styles.inputMaterial}
                ...
                name="direccion_empleado"
                onChange={handleChange}
                value={formValues && formValues.direccion_empleado}
            />
            <br />
            <TextField
                className={styles.inputMaterial}
                ...
                name="rol_id"
                onChange={handleChange}
                value={formValues && formValues.rol_id}
            />
            <br />
            <br />
            <div align="right">
    ...
    const bodyEliminar = (
        <div className={styles.modal}>
            <p>
                ...
                <b>{formValues && formValues.nombre_empleado}</b>?{' '}
            </p>
            <div align="right">
