        ...
        <div>
            ...
            >
                <ButtonGroup variant="contained">
                    <Button
                        onClick={() => {
                            Navigate('/reportes/stockProductos');
                        }}
                    >
                    ...
                    <Button
                        onClick={() => {
                            Navigate('/reportes/ventasEmpleados');
                        }}
                    >
                        Ventas por Empleado
                    </Button>
                    <Button
                        onClick={() => {
                            Navigate('/reportes/comprasClientes');
                        }}
                    >
                    ...
                    <Button
                        onClick={() => {
                            Navigate('/reportes/productosMasVendidos');
                        }}
                    >
